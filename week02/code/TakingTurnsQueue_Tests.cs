...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue removed the wrong person because Dequeue returned and removed the last person added
    ...
    // Defect(s) Found: The method correctly throws an InvalidOperationException with the message "No one in the queue."
