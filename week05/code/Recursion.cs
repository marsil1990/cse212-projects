...
public static class Recursion
{
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        else
        {
            ...
            string part1 = pattern[..position] + "0" + pattern[(position + 1)..];
            string part2 = pattern[..position] + "1" + pattern[(position + 1)..];
            WildcardBinary(part1, results);
            WildcardBinary(part2, results);
        }
    }
